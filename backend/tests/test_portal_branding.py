...
def test_portal_title_from_trading_name() -> None:
    firm = FirmSettings(id=1, trading_name="Burrows Solicitors")
    assert firm_display_name(firm) == "Burrows Solicitors"
    assert portal_title(firm) == "Burrows Solicitors Portal"
