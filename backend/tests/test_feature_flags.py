...
def test_open_pdf_in_onlyoffice_default_on(monkeypatch: pytest.MonkeyPatch) -> None:
...
def test_open_pdf_in_onlyoffice_disabled(monkeypatch: pytest.MonkeyPatch) -> None:
...
def test_open_pdf_in_onlyoffice_explicit_on(monkeypatch: pytest.MonkeyPatch) -> None:
